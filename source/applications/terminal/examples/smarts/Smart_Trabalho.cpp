...
/* 
 * File:   Smart_Trabalho.cpp
 * Author: rlcancian
 * 
 * Created on 24 de Setembro de 2019, 16:43
 */

#include "Smart_Trabalho.h"
 ...
 */
int Smart_Trabalho::main(int argc, char** argv) {
	...
	model->save("./models/Smart_Trabalho.gen");
